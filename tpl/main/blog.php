<?php the_sidebar(); ?>
<div class="main-holder pad-holder row-fluid nomargin flexbox">
<div class="blog-holder span9 nomargin"  style="padding-right:5px; border-right: 1px solid #ededed;">
<?php 
...
<header>
<a class="text-primary" href="'.article_url($ar->pid, $ar->title).'" title="'._html($ar->title).'"><h3>'._html($ar->title).'</h3></a>
</header>';
