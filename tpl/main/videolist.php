...
<div class="tabs-area">
    <div class="tabs-wrapper">
      <div class="tabs-container">
          <a href="<?php echo list_url('browse'); ?>" class="tab <?php aTab(browse);?>">
            <span class="content">
          ...
          <a href="<?php echo list_url(mostliked); ?>" class="tab <?php aTab(mostliked);?>">
            <span class="content">
              <span class="title"><?php echo _lang('Most Liked'); ?></span>
			   <span class="count"><?php echo _lang('Selected by user likes'); ?></span>
            </span>
          </a>
           <a href="<?php echo list_url(mostcom); ?>" class="tab <?php aTab(mostcom);?>">
            <span class="content">
