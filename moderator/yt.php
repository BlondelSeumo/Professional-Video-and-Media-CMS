...
<div class="controls">
<input type="text" name="q" class="validate[required] span8" value=""> 						
</div>	
</div>
<div class="control-group">
...
<div class="controls">
<input type="text" name="channelID" class="span4" value=""> 	
...
<div class="controls">
<input type="text" name="regionCode" class="span1" value=""> 	
...
<div class="controls">
<input type="text" name="relevanceLanguage" class="span1" value=""> 	
...
<div class="controls">
<input type="text" name="pID" class="validate[required] span8" value=""> 						
</div>	
</div>
<div class="control-group">
	<label class="control-label">Video import mode</label>
...
<div class="controls">
  <div class="row-fluid">
  <div class="span4">
<input type="text" name="c" class="span12" value="" placeholder="Channel ID"> 
</div>
<div class="span1"> <strong class="redText">OR</strong> </div>	
<div class="span4">					
<input type="text" name="chName" class="span12" value="" placeholder="Channel Name"> 						
</div>
</div>
</div>	
</div>
