...
<div class="controls">
<input type="text" name="name" class="validate[required] span12" value="<?php echo _html($ad->jad_title); ?>"/> 	
...
<div class="controls">
<textarea rows="5" cols="5" name="content" class="span12" style="word-wrap: break-word; resize: horizontal; height: 88px;"><?php echo stripslashes($ad->jad_body); ?></textarea>					
...
<div class="control-group">
	...
	<div class="controls">
<input type="text" name="sec" class="validate[required] span4" value="<?php echo _html($ad->jad_start); ?>"/> 	
...
<div class="control-group">
	...
	<div class="controls">
<input type="text" name="end" class="validate[required] span4" value="<?php echo _html($ad->jad_end); ?>"/> 	
