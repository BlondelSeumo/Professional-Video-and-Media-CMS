...
<?php echo'<a class="btn btn-default" style="margin-right:10px" href="'.admin_url('create-videoad').'&type=1"><i class="icon-plus-sign"></i>Create Overlay</a>'; ?>			
<?php echo'<a class="btn btn-default" style="margin-right:10px" href="'.admin_url('create-videoad').'&type=2"><i class="icon-plus-sign"></i>Create Annotation</a>'; ?>
<?php echo'<a class="btn btn-default" style="margin-right:10px" href="'.admin_url('create-videoad').'&type=3"><i class="icon-plus-sign"></i>Create Pre/Post Roll</a>'; ?>
</div>
</div>
<?php
if($ads) {
                        ...
                        <table class="table table-bordered table-checks">
						  ...
						  <?php foreach ($ads as $ad) { ?>
							  ...
							  <td><?php echo _html($ad->jad_id); ?></td>
								  ...
								  <td class="lastone">
								  <div class="btn-group">
								 <a class="btn btn-default tipS" href="<?php echo admin_url('edit-videoad');?>&id=<?php echo $ad->jad_id;?>" title="Edit <?php echo _html($ad->jad_title); ?>"><i class="icon-pencil" style=""></i></a>
