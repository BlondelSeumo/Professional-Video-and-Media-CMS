...
<form id="validate" class="form-horizontal styled" action="<?php echo admin_url('edit-block').'&id='.intval($_GET['id']);  ?>" enctype="multipart/form-data" method="post">
	...
	<div class="controls">
	<input type="text" id="title" name="title" class="span12" value="<?php echo _html($box->title); ?>">
	</div>
	</div>	
	<div class="control-group">
	<label class="control-label">Videos limit</label>
	<div class="controls">
	<input type="text" id="number" name="number" class="span4 validate[required]" value="<?php echo _html($box->total); ?>">
...
echo '<div class="box-element span6">
Missing block? </div>
';
}
echo '<div class="box-element span6">	
