...
?>
<div class="row-fluid">
<form id="validate" class="form-horizontal styled" action="<?php echo admin_url('edit-ad');?>" enctype="multipart/form-data" method="post">
<fieldset>
<input type="hidden" name="id" value="<?php echo $id; ?>">
<div class="control-group">
<label class="control-label"><i class="icon-copy"></i>Ad title</label>
<div class="controls">
<input type="text" name="name" class="validate[required] span12" value="<?php echo _html($ad->ad_title); ?>"/> 	
...
<div class="controls">
<input type="text" name="spot" class="span12" value="<?php echo _html($ad->ad_spot); ?>"/> 
<br /> - OR SELECT EXISTING - <br />
<?php
$predef = "sidebar-start,before-videoplayer,after-videoplayer,sidebar-end,search-top,search-bottom,search-sidebar-top,search-sidebar-bottom,top-of-comments,after-comments,related-videos-top,video-list-bottom,video-list-top,blog-sidebar-top,blog-sidebar-bottom,home-start,home-end,users-top,users-bottom,members-sidebar,playlists-top,playlists-sidebar,playlists-bottom,after-video-carousel,after-video-loop";
...
<div class="controls">
<textarea rows="5" cols="5" name="content" class="span12" style="word-wrap: break-word; resize: horizontal; height: 88px;"><?php echo stripslashes($ad->ad_content); ?></textarea>					
